...
public class ProductHelperMethods {
	...
	public static boolean filtersChecker(ProductDto product, Boolean active, Long parentId, String language,
			String country, String searchTerm, Boolean discounted) {
		...
		if (activeMatches && parentMatches) {
			if (searchTerm != null && !searchTerm.isEmpty()) {
				if (product.getCode() != null && product.getCode().toLowerCase().contains(searchTerm.toLowerCase())) {
	...
	public static long totalNumberCalculator(List<ProductDto> products, String language, Long parentId,
		...
		for (ProductDto product : products) {
			if (filtersChecker(product, active, parentId, language, country, searchTerm, discounted)) {
				++result;
			}
		}
		return result;
