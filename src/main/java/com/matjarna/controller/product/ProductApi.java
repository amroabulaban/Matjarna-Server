...
public class ProductApi {
	...
	public ResponseEntity<ProductDto> getProductById(@PathVariable("id") Long id, Country country, Language language) {
		ProductDto productDto = productFacade.getProductById(id, country, language);
		return ResponseEntity.ok(productDto);
	}

	@GetMapping(value = "private/product/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ProductDto> getProductById(@PathVariable("id") Long id) {
		ProductDto productDto = productFacade.getProductById(id, null, null);
		return ResponseEntity.ok(productDto);
	}
