...
public class UserApi {
	...
	@PostMapping(value = "private/admin/create", produces = MediaType.APPLICATION_JSON_VALUE)
	public UserDto createAdmin(@RequestBody @Valid RegisterRequest registerRequest) {
		return userFacade.createAdmin(registerRequest);
	}

	@PostMapping(value = "customer/register", produces = MediaType.APPLICATION_JSON_VALUE)
	public UserDto createCustomer(@RequestBody @Valid RegisterRequest registerRequest) {
		return userFacade.createCustomer(registerRequest);
	}
